...
For general warehouse operations, see [Warehouse Operations](/yanzhe-Xiao/yuncang/4-warehouse-operations). For system configuration settings, see [Factory Configuration](/yanzhe-Xiao/yuncang/6.1-factory-configuration).
